  ...
  <head>
	...
	<script>
		$(document).ready(function() {
			...
			$('#market').attr('class','nav-link active')
			fetch('${pageContext.request.contextPath}/signal/innerbar/marketbar.do').then(function(response){
		    ...
		    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		      ...
		      <canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas>
		            ...
		            <dl class="line">
		                <dd>
		                    <ul class="nav nav-tabs" role="tablist">
		                        <li class="month" role="presentation"><button id="month" name="btnDate" class="nav-link active" onclick="showChart('month');">1개월</button></li>
		                        <li class="month3" role="presentation"><button id="month3" name="btnDate" class="nav-link" onclick="showChart('month3');">3개월</button></li>
		        ...
		        <div class="flash_area">
            		<img src="https://ssl.pstatic.net/imgfinance/chart/marketindex/area/month/FX_USDKRW.png?sidcode=20210815" width="700" alt="차트" onerror="this.src='https://ssl.pstatic.net/imgstock/chart3/world2008/error_700x243.gif'">
       	 		</div>
