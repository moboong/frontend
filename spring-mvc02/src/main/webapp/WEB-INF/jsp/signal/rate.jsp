  ...
  <head>
	...
	<script>
		$(document).ready(function() {
			...
			$('#rate').attr('class','nav-link active')
			fetch('${pageContext.request.contextPath}/signal/innerbar/ratebar.do').then(function(response){
		...
		jindo.$Fn(function() {
			...
			jindo.$$('title')[0].innerHTML = "콜금리(1일) : 네이버 금융";
        ...
        function showChart(target) {
            ...
            jindo.$A(jindo.$$("dl.line dd ul li")).forEach(function(v) {
                if (jindo.$Element(v).className() == target) {
                    ...
                    welChart.attr("src", "https://ssl.pstatic.net/imgfinance/chart/marketindex/area/" + target + "/IRR_CALL.png?sidcode=" + jindo.$Date(new Date()).format("Ymd"));
                } else {
		    ...
		    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		      ...
		      <canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas>
		       ...
		       <div class="flash_area">
				  ...
				  <img src="https://ssl.pstatic.net/imgfinance/chart/marketindex/area/month3/IRR_CALL.png?sidcode=<c:out value="${sysDate}" />" width="700" alt="차트" onerror="this.src='https://ssl.pstatic.net/imgstock/chart3/world2008/error_700x243.gif'">
			   </div>
