...
<div id="8" class="col-xl-6 col-md-12 custcard">
	<div class="card">
		...
		<div class="card-block">
			<img src="https://ssl.pstatic.net/imgfinance/chart/marketindex/area/month3/FX_CNYKRW.png" width="700" alt="차트" onerror="this.src='https://ssl.pstatic.net/imgstock/chart3/world2008/error_700x243.gif'">
		</div>
	</div>
</div>